...
public class lavacake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        likeCountTextView = findViewById(R.id.likeCountTextView4);
        dislikeCountTextView = findViewById(R.id.dislikeCountTextView4);

        // citanje korisnickog imena iz datoteke
        username = readFromFile("user_data.txt");
        checkAndCreateFile();

        trbrojlike();

        ImageView myImageView = findViewById(R.id.homeIcon4);
        ...
        ImageView myImageView2 = findViewById(R.id.notificationsIcon4);
    ...
    private void checkAndCreateFile() {
        String fileName = "lavacakeLiked.txt";
    ...
    public String generateLikeId(String username) {
        String userLike = username + "_liked_lavacake";
        return userLike;
    }
    ...
    private boolean hasUserLiked(String likeId) {
        String contentFromFile = readFromFile("lavacakeLiked.txt");
    ...
    public String generateDislikeId(String username) {
        String userDislike = username + "_disliked_lavacake";
        return userDislike;
    }

    private boolean hasUserDisliked(String dislikeId) {
        String contentFromFile = readFromFile("lavacakeDisliked.txt");
