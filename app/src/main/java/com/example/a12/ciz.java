...
public class ciz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        likeCountTextView = findViewById(R.id.likeCountTextViewCiz);
        dislikeCountTextView = findViewById(R.id.dislikeCountTextViewCiz);
        ...
        ImageView myImageView = findViewById(R.id.homeIconCiz);
        ...
        ImageView myImageView2 = findViewById(R.id.notificationsIconCiz);
    ...
    public String generateLikeId(String username) {
        String userLike = username + "_liked_ciz";
        return userLike;
    }
    ...
    private boolean hasUserLiked(String likeId) {
        String contentFromFile = readFromFile("cizLiked.txt");
    ...
    public String generateDislikeId(String username) {
        String userDislike = username + "_disliked_ciz";
        return userDislike;
    }

    private boolean hasUserDisliked(String dislikeId) {
        String contentFromFile = readFromFile("cizDisliked.txt");
