...
public class passta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        likeCountTextView = findViewById(R.id.likeCountTextView3); // Promijenite ID-a na odgovarajući u vašem XML-u
        dislikeCountTextView = findViewById(R.id.dislikeCountTextView3); // Promijenite ID-a na odgovarajući u vašem XML-u
        ...
        ImageView myImageView = findViewById(R.id.homeIcon3); // Promijenite ID-a na odgovarajući u vašem XML-u
        ...
        ImageView myImageView2 = findViewById(R.id.notificationsIcon3); // Promijenite ID-a na odgovarajući u vašem XML-u
    ...
    private void checkAndCreateFile() {
        String fileName = "tjesteninaLiked.txt"; // Promijenite naziv datoteke za "tjestenina"
    ...
    public String generateLikeId(String username) {
        String userLike = username + "_liked_tjestenina"; // Promijenite naziv za "tjestenina"
        return userLike;
    }
    ...
    private void updateCounts() {
        ...
        int currentLikeCount = sharedPreferences.getInt("like_count_tjestenina", 0); // Učitaj trenutni broj lajkova
    ...
    private void openSongFragment() {
        Intent intent = new Intent(passta.this, MainActivity.class);
        String poruka = "song";
    ...
    private boolean hasUserLiked(String likeId) {
        String contentFromFile = readFromFile("tjesteninaLiked.txt"); // Promijenite naziv datoteke za "tjestenina"
        return contentFromFile.contains(likeId);
    }

    private void markUserLiked(String likeId) {
        writeToFile("tjesteninaLiked.txt", likeId + "\n"); // Promijenite naziv datoteke za "tjestenina"
    }
    ...
    private void updateCounts1() {
        ...
        int currentLikeCount = sharedPreferences.getInt("dislike_count_tjestenina", 0); // Učitaj trenutni broj dislajkova
    ...
    public String generateDislikeId(String username) {
        String userDislike = username + "_disliked_tjestenina"; // Promijenite naziv za "tjestenina"
        return userDislike;
    }

    private boolean hasUserDisliked(String dislikeId) {
        String contentFromFile = readFromFile("tjesteninaDisliked.txt"); // Promijenite naziv datoteke za "tjestenina"
